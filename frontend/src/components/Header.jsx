    ...
    <>
      <header className="sticky top-0 z-50 pt-3">
        <div className="mx-auto w-full max-w-[1360px] px-4 sm:px-6 lg:px-8">
          <div className="rounded-[20px] border border-slate-200/80 bg-white/72 px-4 py-3 backdrop-blur-md dark:border-slate-700/80 dark:bg-slate-900/80 sm:px-5 lg:px-6">
