...
function Header({ navigation }) {
  ...
  return (
    <header className="sticky top-0 z-40 pt-4">
      <div className="glass-panel flex items-center justify-between px-5 py-4 md:px-7">
        <Link to="/" className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-900 text-white dark:bg-slate-700">
            <FileOutput className="h-6 w-6" />
          </div>
          <div>
            <p className="font-display text-lg font-extrabold text-slate-900 dark:text-slate-50">PDF XinoConvert</p>
            <p className="text-xs uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">Ferramentas de Produtividade</p>
          </div>
        </Link>
