...
const ResultCard = forwardRef(function ResultCard({ title, description, children, tone = 'default', className = '' }, ref) {
  const tones = {
    ...
    info: 'border-brand-100 bg-brand-50/80 dark:border-brand-700 dark:bg-brand-900/35',
  };

  return (
    <div ref={ref} className={`rounded-[28px] border p-6 shadow-soft ${tones[tone]} ${className}`.trim()}>
