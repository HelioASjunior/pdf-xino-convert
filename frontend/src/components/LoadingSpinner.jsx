function LoadingSpinner({ label = 'Processando...' }) {
  return (
    <div className="inline-flex items-center gap-3 rounded-full bg-brand-50 px-4 py-2 text-sm font-semibold text-brand-700 dark:bg-brand-900/35 dark:text-brand-200">
